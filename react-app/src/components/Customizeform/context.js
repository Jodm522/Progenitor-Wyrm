...
export const equipment = {
  ...
  burglarsPack: { name: "Burglar's Pack", index: "burglars-pack" },
  componentPouch: { name: "Component Pouch", index: "component-pouch" },
  diplomatsPack: { name: "Diplomat's Pack", index: "diplomats-pack" },
  druidicFocus: {
    name: "Druidic Focus",
    desc: "A druid can use a Sprig of Mistletoe (or holly) as a spellcasting focus.",
  },
  dungeoneersPack: { name: "Dungeoneer's Pack", index: "dungeoneers-pack" },
  entertainersPack: { name: "Entertainer's Pack", index: "entertainers-pack" },
  explorersPack: { name: "Explorer's Pack", index: "explorers-pack" },
  holySymbol: {
    name: "Holy Symbol",
    desc: "A holy symbol is a representation of a god or pantheon. A cleric or paladin can use a holy symbol as a spellcasting focus",
  },
  musicalInstrument: {
    name: "Musical Instrument",
    desc: "Any musical instrument.",
  },
  priestsPack: { name: "Priest's Pack", index: "priests-pack" },
  scholarsPack: { name: "Scholar's Pack", index: "scholars-pack" },
  spellbook: { name: "Spellbook", index: "spellbook" },
  thievesTools: { name: "Thieves' Tools", index: "thieves-tools" },
};
export const armors = {
  padded: {
...
export const classes = {
  barbarian: {
    ...
    starting_weapons: [{ quantity: 4, weapon: weapons.simple_weapons.javelin }],
    starting_equip: [equipment.explorersPack],
    ...
    starting_weap_options: [
      {
        ...
        choose: 1,
        from: [
          { quantity: 1, weapon: weapons.martial_weapons.battleaxe },
          { quantity: 1, weapon: weapons.martial_weapons.flail },
          { quantity: 1, weapon: weapons.martial_weapons.glaive },
          { quantity: 1, weapon: weapons.martial_weapons.greataxe },
          { quantity: 1, weapon: weapons.martial_weapons.halberd },
          { quantity: 1, weapon: weapons.martial_weapons.lance },
          { quantity: 1, weapon: weapons.martial_weapons.longsword },
          { quantity: 1, weapon: weapons.martial_weapons.maul },
          { quantity: 1, weapon: weapons.martial_weapons.morningstar },
          { quantity: 1, weapon: weapons.martial_weapons.pike },
          { quantity: 1, weapon: weapons.martial_weapons.rapier },
          { quantity: 1, weapon: weapons.martial_weapons.scimitar },
          { quantity: 1, weapon: weapons.martial_weapons.shortsword },
          { quantity: 1, weapon: weapons.martial_weapons.trident },
          { quantity: 1, weapon: weapons.martial_weapons.warPick },
          { quantity: 1, weapon: weapons.martial_weapons.warHammer },
          { quantity: 1, weapon: weapons.martial_weapons.whip },
          { quantity: 1, weapon: weapons.martial_ranged.blowgun },
          { quantity: 1, weapon: weapons.martial_ranged.handCrossbow },
          { quantity: 1, weapon: weapons.martial_ranged.heavyCrossbow },
          { quantity: 1, weapon: weapons.martial_ranged.longbow },
        ],
      },
      {
        option: 2,
        choose: 1,
        from: [
          { quantity: 2, weapon: weapons.simple_weapons.handAxe },
          { quantity: 1, weapon: weapons.simple_weapons.club },
          { quantity: 1, weapon: weapons.simple_weapons.dagger },
          { quantity: 1, weapon: weapons.simple_weapons.greatClub },
          { quantity: 1, weapon: weapons.simple_weapons.javelin },
          { quantity: 1, weapon: weapons.simple_weapons.lightHammer },
          { quantity: 1, weapon: weapons.simple_weapons.mace },
          { quantity: 1, weapon: weapons.simple_weapons.quarterstaff },
          { quantity: 1, weapon: weapons.simple_weapons.sickle },
          { quantity: 1, weapon: weapons.simple_weapons.spear },
          { quantity: 1, weapon: weapons.simple_ranged.lightCrossbow },
          { quantity: 1, weapon: weapons.simple_ranged.dart },
          { quantity: 1, weapon: weapons.simple_ranged.shortbow },
          { quantity: 1, weapon: weapons.simple_ranged.sling },
        ],
      },
    ],
    hitDie: 12,
  ...
  bard: {
    ...
    starting_equip: [equipment.musicalInstrument],
    starting_equip_options: [
      {
        option: 1,
        choose: 1,
        from: [equipment.diplomatsPack, equipment.entertainersPack],
      },
    ],
    starting_weapons: [{ quantity: 1, weapon: weapons.simple_weapons.dagger }],
    starting_weap_options: [
      {
        option: 1,
        choose: 1,
        from: [
          ...
          { quantity: 1, weapon: weapons.simple_weapons.dagger },
          { quantity: 1, weapon: weapons.simple_weapons.greatClub },
          { quantity: 1, weapon: weapons.simple_weapons.handAxe },
          { quantity: 1, weapon: weapons.simple_weapons.javelin },
          { quantity: 1, weapon: weapons.simple_weapons.lightHammer },
          { quantity: 1, weapon: weapons.simple_weapons.mace },
          { quantity: 1, weapon: weapons.simple_weapons.quarterstaff },
  ...
  cleric: {
    ...
    starting_equip: [equipment.holySymbol],
    starting_equip_options: [
      {
        option: 1,
        choose: 1,
        from: [equipment.priestsPack, equipment.explorersPack],
      },
    ],
    starting_weapons: [],
    starting_weap_options: [
  ...
  druid: {
    ...
    starting_equip: [equipment.explorersPack, equipment.druidicFocus],
    starting_equip_options: [],
    starting_weapons: [],
    starting_weap_options: [
      {
    ...
    starting_equip_options: [
      {
        option: 1,
        choose: 1,
        from: [equipment.dungeoneersPack, equipment.explorersPack],
      },
    ],
    starting_weap_options: [
      {
  ...
  monk: {
    ...
    starting_weapons: [{ quantity: 10, weapon: weapons.simple_ranged.dart }],
    starting_weap_options: [
      {
        option: 1,
        choose: 1,
  ...
  paladin: {
    ...
    starting_weap_options: [
      ...
      },
      {
        ...
        choose: 1,
        from: [
          { quantity: 5, weapon: weapons.simple_weapons.javelin },
          { quantity: 1, weapon: weapons.simple_weapons.club },
          { quantity: 1, weapon: weapons.simple_weapons.dagger },
          { quantity: 1, weapon: weapons.simple_weapons.greatClub },
          { quantity: 1, weapon: weapons.simple_weapons.handAxe },
  ...
  ranger: {
    ...
    starting_equip: [{ quantity: 1, weapon: weapons.martial_ranged.longbow }],
    starting_equip_options: [
      {
        option: 1,
        choose: 1,
  ...
  rogue: {
    ...
    starting_equip: [equipment.thievesTools],
    starting_equip_options: [
      {
        option: 1,
        choose: 1,
        from: [
          equipment.burglarsPack,
          equipment.dungeoneersPack,
          equipment.explorersPack,
        ],
      },
    ],
    starting_weapons: [{ quantity: 2, weapon: weapons.simple_weapons.dagger }],
    starting_weap_options: [
      {
        option: 1,
        choose: 1,
    ...
    starting_equip_options: [
      {
        option: 1,
        choose: 1,
        from: [equipment.componentPouch, equipment.arcaneFocus],
      },
      {
        option: 2,
        choose: 1,
  ...
  warlock: {
    ...
    starting_equip_options: [
      ...
      },
      {
        option: 2,
        choose: 1,
        from: [equipment.dungeoneersPack, equipment.scholarsPack],
      },
    ],
    starting_weap_options: [
      {
  ...
  wizard: {
    ...
    starting_equip: [equipment.spellbook],
    starting_equip_options: [
      {
        option: 1,
        choose: 1,
